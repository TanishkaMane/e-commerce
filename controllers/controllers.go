...
import (
	...
	generate "github.com/tanishkamane/ecommerce/tokens"
...
var UserCollection *mongo.Collection = database.GetMongoCollection(database.Client, "Users")
var ProductCollection *mongo.Collection = database.GetMongoCollection(database.Client, "Products")
...
func SearchProductByQuery() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = seacrhQueryDb.All(ctx, &searchProducts)
		if err != nil {
			log.Println(err)
			c.IndentedJSON(400, "invalid")
			return
